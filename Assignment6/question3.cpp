...
class Employee : public Person
{
    ...
    Employee(string name, string address, int day0, int month0, int year0, int id, float salary, string dept, int day, int month, int year): doj(day, month, year), Person(name, address, day0, month0, year0)
    {
        this->id = id;
        this->salary = salary;
        this->dept = dept;
...
enum MainMenu{EXIT, PERSON, EMPLOYEE};
MainMenu menu()
{
    int choice;
    cout << "-------------------" << endl;
